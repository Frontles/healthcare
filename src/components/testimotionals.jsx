...
const Testimotionals = () => {
    return (
        <div className='container my-20 space-y-4 flex flex-col items-center justify-center'>
            ...
            <h2 className='text-6xl text-blackText  pb-6'>Lets See What Our Patenties Says</h2>
            <p className='text-3xl text-linkdefault pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur non porro quidem rem eius, assumenda cupiditate perspiciatis! Veritatis, quos officia!</p>
