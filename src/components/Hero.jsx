        ...
        <section className='bg-bgPrimary pb-10'>
            <div className='container flex flex-col md:flex-row px-4 md:px-0 '>
                <div className='basis-4/5 flex flex-col gap-5 justify-evenly'>
                    ...
                    <h1 className='font-semibold text-5xl md:text-6xl lg:text-8xl text-blackText leading-tight'>Bringing <span className='text-primary'>Smiles</span><br /> Back to Health.</h1>
                    <p className=' text-linkdefault px-4 py-2 rounded-lg text-xl md:text-2xl max-w-fit leading-relaxed' >Connecting you with the best healthcare professionals <br /> and resources using technology and innovation</p>
                    ...
                    <div className='flex items-center md:items-baseline'>
                        <p className='text-primary text-3xl md:text-5xl border-r pr-8 pl-1 font-bold'>100K+</p>
                        <p className='text-linkdefault text-lg md:text-2xl max-w-xs px-8 text-center '>Serving patient both Online and Offline</p>
                    </div>
                ...
                <div className='basis-3/5 flex flex-col space-y-4 '>
                    <div className=' relative aspect-video items-start'>
                        ...
                        <p className='absolute bottom-4 right-4  p-2 md:p-4 bg-transparent rounded-full text-white border-2 border-white'><BsArrowUpRight className='text-lg md:text-2xl' /></p>
